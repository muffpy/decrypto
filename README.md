...
I used C++ for the second one as unordered_map was readily available to implement a hash table - therefore, I converted key.c to key.hpp to experiemnt with splitting sums idea.
`decrypt.c` still pending
